...
const LandingPage = () => {
    ...
    const types = [
        { id: 'combo', label: 'ফুল কম্বো সেট (মা + মেয়ে + হিজাব)', price: prices.combo },
        { id: 'ma_single', label: 'সিঙ্গেল বোরকা (মা)', price: prices.ma_single },
        { id: 'baby_single', label: 'সিঙ্গেল বোরকা (বাচ্চা)', price: prices.baby_single },
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight">
                            মা ও মেয়ের <span className="text-premium-gold">স্পেশাল কম্বো</span> বোরকা সেট
                        </h1>
                        <p className="text-lg text-gray-600 max-w-xl">
                            মা ও মেয়ের জন্য বিশেষভাবে তৈরি এই বোরকা হিজাব কম্বো সেট আপনাকে দেবে পরিপূর্ণ পর্দাশীলতা ও এলিগ্যান্ট লুক একসাথে। মিনিমাল স্টোন ও সুন্দর কাটিংয়ের ডিজাইন।
                        </p>
                    ...
                    >
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 glass-morphism p-4 rounded-2xl flex justify-between items-center">
                                <div>
                                    <p className="text-sm font-medium opacity-70 italic">মা-মেয়ে ম্যাচিং সেট</p>
                                    <p className="text-2xl font-bold text-premium-gold">১৬৮০ ৳ <span className="text-sm line-through text-gray-400 ml-2">১৯৯০ ৳</span></p>
                                </div>
            ...
            <section id="products" className="py-20 px-4 md:px-6 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 space-y-4">
                        <h2 className="text-3xl md:text-5xl font-bold">মা-মেয়ে স্পেশাল কম্বো</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {colors.map((color, index) => {
                            ...
                            const [babySize, setBabySize] = useState('৩০');
                                ...
                                >
                                    ...
                                    <div className="p-6 space-y-5 flex-1 flex flex-col">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                <option value="combo">ফুল কম্বো সেট (মা+মেয়ে)</option>
                                                <option value="ma_single">সিঙ্গেল বোরকা (মা)</option>
                                                <option value="baby_single">সিঙ্গেল বোরকা (বাচ্চা)</option>
                                            </select>
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {(itemType === 'combo' || itemType === 'baby_single') && (
                                                <div className="space-y-2">
                                                    <p className="text-xs font-bold text-gray-500 uppercase">পছন্দের সাইজ (বাচ্চা):</p>
                                                    <div className="flex flex-wrap gap-2">
                                                        {['৩০', '৩২', '৩৪', '৩৬', '৩৮', '৪০'].map(size => (
                                                            <button
                                                                key={size}
                                        ...
                                        <div className="pt-4 mt-auto space-y-4">
                                            ...
                                            <div className="flex flex-col gap-3">
                                                <button
                                                    onClick={() => {
                                                        addToCart({
                                                            id: `classic_${color.name}_${itemType}_${withHijab ? 'with_hijab' : 'no_hijab'}`,
                                                            name: `ক্লাসিক ডিজাইন - ${color.name} (${itemType})`,
                                                            color: color.name,
                                                            size: itemType === 'combo' ? `মা: ${itemSize}, বাচ্চা: ${babySize}` : (itemType === 'ma_single' ? itemSize : babySize),
                                                ...
                                                <button
                                                    onClick={() => {
                                                        ...
                                                        setQuantity(itemQty);
                                                        setSelectedSize(itemType === 'combo' ? `মা: ${itemSize}, বাচ্চা: ${babySize}` : (itemType === 'ma_single' ? itemSize : babySize));
                                                        scrollToForm();
                                                    }}
