...
const KidsCollection = () => {
    ...
    const sizes = ['৩০', '৩২', '৩৪', '৩৬', '৩৮', '৪০', 'কাস্টমাইজ'];
    ...
    const handleOrderSubmit = async (e) => {
        ...
        const orderData = {
            ...
            color: selectedColor,
            size: selectedSize === 'কাস্টমাইজ' ? `কাস্টমাইজ: ${formData.customSize}` : selectedSize,
            quantity,
            price: currentPrice,
        ...
        try {
            ...
            if (SMS_API_KEY && SMS_API_KEY !== 'VoYeTuiZ7OH6ZW1rLFZf' && SMS_API_KEY !== 'PASTE_YOUR_API_KEY_HERE') {
                ...
                const smsMessage = `প্রিয় ${formData.name}, NRZONE এ আপনার কিডস কালেকশন বোরকা অর্ডারটি গ্রহণ করা হয়েছে। শীঘ্রই আমরা আপনাকে কল করবো। ধন্যবাদ!`;
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 bg-neutral-100 text-black px-4 py-1 rounded-full text-sm font-bold">
                            <Sparkles size={16} /> ছোটদের স্পেশাল কালেকশন
                        </div>
                        <h1 className="text-4xl md:text-6xl font-black leading-tight text-[#1A1A1A]">
                            আরামদায়ক ও কিউট <br />
                            <span className="text-black">কিডস বোরকা সেট</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4">
                            ...
                            <div className="flex flex-col justify-center">
                                ...
                                <p className="text-3xl font-black text-black">৳ ৬৯০ <span className="text-base font-medium text-gray-400 line-through ml-2">৳ ৮৫০</span></p>
                            </div>
                        </div>
                    </motion.div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-black mb-4">পছন্দের কালার রিছে নিন</h2>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-8 space-y-6 flex-1 flex flex-col">
                                        <h3 className="text-2xl font-bold">কিডস বোরকা - {color.name}</h3>
                    ...
                    <div className="flex-1 p-8 md:p-12">
                        <form onSubmit={handleOrderSubmit} className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                {selectedSize === 'কাস্টমাইজ' && (
                                    <input
                                        type="text"
                                        placeholder="আপনার সাইজ লিখুন (যেমন: ৪২)"
                                        className="w-full p-4 rounded-2xl bg-gray-50 border-2 border-black outline-none"
